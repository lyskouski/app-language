...
INSERT OR REPLACE INTO languages (locale, name, logo_path, is_active, display_order) VALUES
    ...
    ('DE', 'Deutsch', 'assets/images/language/de.png', 1, 2),
    ('FR', 'Français', 'assets/images/language/fr.png', 1, 3),
    ('BE', 'Беларуская', 'assets/images/language/be.png', 1, 4),
    ('RU', 'Русский', 'assets/images/language/ru.png', 1, 5),
    ('UK', 'Українська', 'assets/images/language/uk.png', 1, 6),
    ('PL', 'Polski', 'assets/images/language/pl.png', 1, 7);
