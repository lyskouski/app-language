labels_uk = {
    ...
    "status_comparing_audio": "Порівняння вимови...",
    "status_comparison_result": "Оцінка вимови",
    "status_comparison_preparing": "Підготовка порівняння...",
    "status_comparison_processing": "Аналіз вимови...",
    "status_comparison_finalizing": "Формування оцінки...",
    "status_comparison_no_segments": "Поки немає оцінок по сегментах",
    "status_comparison_error": "Не вдалося виконати порівняння",
    "status_comparison_unavailable": "Порівняння недоступне на цьому пристрої",
    "status_comparison_missing_reference": "Виберіть речення перед перевіркою вимови",
    "label_segment_short": "С",
    "label_word_short": "Сл",
    "status_loading": "Загрузка...",
    "language_pair_to_label": "Цільова мова *",
    "language_pair_name_label": "Назва пари *",
