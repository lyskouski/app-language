...
class RecorderWidget(BoxLayout):
    ...
    def load_data(self):
        ...
        for file_name, sentence in self.audio_files.items():
            row = BoxLayout(orientation='horizontal', size_hint_y=None, height=app.theme.md3_button_height + 8)
        ...
        control_layout = BoxLayout(size_hint_y=None, height=app.theme.md3_button_height + 8)
