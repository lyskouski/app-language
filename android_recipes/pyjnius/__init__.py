...
class PyjniusRecipe(CythonRecipe):
    """Custom recipe using CythonRecipe (setup.py) instead of PyProjectRecipe (pyproject.toml)
    ...
    def get_recipe_env(self, arch, **kwargs):
        ...
        # NDKPLATFORM is our switch for detecting Android platform
