...
class KivyRecipe(CythonRecipe):
    """Custom Kivy recipe using CythonRecipe (setup.py) instead of PyProjectRecipe (pyproject.toml)
    to avoid isolated build environment issues with setuptools.build_meta in build 1.4.0+"""
    ...
    def get_recipe_env(self, arch, **kwargs):
        ...
        # Standard Kivy env setup from original recipe
