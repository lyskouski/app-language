...
icon.filename = android/logo.png
...
# CRITICAL: Enable custom PyJNIus recipe to bypass isolated build environment issue
# PyJNIus default uses PyProjectRecipe → python -m build → isolated env → setuptools.build_meta unavailable
# Custom recipe uses CythonRecipe (setup.py) which works without isolation
